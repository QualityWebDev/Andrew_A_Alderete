class siteHeader extends HTMLElement {
    ...
    connectedCallback() {
        this.innerHTML = `
            ...
            <a href="/contact/contact.html" class="bg-gray-900 text-gray-100 px-3 py-1 rounded-lg animate-[bounce_1s_ease-in-out_infinite]  hover:animate-none">Contact Us</a>
            <div class="flex">
